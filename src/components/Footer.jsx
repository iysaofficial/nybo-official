    ...
    return(
        ...
        <div className="content">
            ...
            <div className="link-boxes">
                    <ul className="box">
                        <li className="link_name">NYBO</li>
                    ...
                    <ul className="box">
                        ...
                        <li><a href="#">Link Registrasi</a></li>
                    ...
                    <ul className="box">
                        ...
                        <li><a href='mailto:nybo.officiall@gmail.com' target='_blank' className="">nybo.officiall@gmail.com</a></li>
        ...
        <div className="bottom-details">
            <div className="bottom_text">
                <span className="copyright_text">Copyright &#169; 2024 <a href="#">NYBO Official.</a>All rights reserved</span>
